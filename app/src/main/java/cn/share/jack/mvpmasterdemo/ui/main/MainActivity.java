 ...
 * @author jack
 */
public class MainActivity extends BaseActivity<MainPresenter> implements MainView<List<MainInfo>>,
        CygBaseRecyclerAdapter.OnItemClickListener<MainViewHolder> {
